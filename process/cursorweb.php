...
class Cursor{
	...
	private $db_name = 'creditplus1';
	private $db_user ='root';
	private $host = 'localhost';
	private $db_pass = "!Log19tan88";
	...
	public function getRows($table, $columns = null, $where = null, $order = null, $limit = null, $where_extra = null){
		$_cols = ""; $_cls = "";
		if($this->connect()){
			if($columns == null) $_cols = "*";
			else {
			...
			$sql->execute();
			if($result = $sql->rowCount()) return $result;
		}
		return false;
	}
	...
	// 		$sql = $this->con->prepare("SELECT * FROM `{$table}` ");
